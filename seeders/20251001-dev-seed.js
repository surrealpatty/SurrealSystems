...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    if (svcUserId) {
      ...
      const servicesToInsert = servicesToEnsure.filter(s => !existingKey.has(`${s.title}::${s.userId}`));
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkDelete('users', { email: { [Op.in]: ['devuser@example.com', 'svcuser@example.com'] } }, {});
  }
};
